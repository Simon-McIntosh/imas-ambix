# ============================================================
# TRACK A: FROZEN MWE-01 v1 — DO NOT MODIFY
# Source: git blob b3a71b6:scripts/drain-tests/mwe-01-sigterm-delay.py
# Frozen: 2026-06-03 for drain-window-campaign backward bisection
# This is the pre-fix code that drained the node as job 1209813 on 2026-06-01.
# Faithfulness is the point. Do not refactor, fix, or improve.
# ============================================================
"""
...
def main() -> None:
    print("[track_a_frozen] FROZEN MWE-01 v1 — pre-928ed0d — drain artifact", flush=True)
