...
def main() -> None:
    print("[bisect_01] sync_second_call — all ranks enter blind-window collective", flush=True)
    ...
    if rank == 0 and results:
        ...
        csv_path = os.path.join(LOG_DIR, f"bisect01_results_{os.environ.get('SLURM_JOB_ID','local')}.csv")
