...
if [[ "$CLIVE_OPENROUTER" != "1" ]]; then
    ...
    ANTHROPIC_DEFAULT_OPUS_MODEL_DESCRIPTION="unused tier - routes to $AMBIX_MODEL" \\
    ANTHROPIC_DEFAULT_SONNET_MODEL="$AMBIX_MODEL" \\
    ANTHROPIC_DEFAULT_SONNET_MODEL_NAME="—" \\
    ANTHROPIC_DEFAULT_SONNET_MODEL_DESCRIPTION="unused tier - routes to $AMBIX_MODEL" \\
    ANTHROPIC_DEFAULT_HAIKU_MODEL="$AMBIX_MODEL" \\
    ANTHROPIC_DEFAULT_HAIKU_MODEL_NAME="—" \\
    ANTHROPIC_DEFAULT_HAIKU_MODEL_DESCRIPTION="unused tier - routes to $AMBIX_MODEL" \\
    ANTHROPIC_DEFAULT_FABLE_MODEL="$AMBIX_MODEL" \\
    ANTHROPIC_DEFAULT_FABLE_MODEL_NAME="—" \\
    ANTHROPIC_DEFAULT_FABLE_MODEL_DESCRIPTION="unused tier - routes to $AMBIX_MODEL" \\
