...
if [[ "$CLIVE_OPENROUTER" != "1" ]]; then
    ...
    ANTHROPIC_DEFAULT_OPUS_MODEL_DESCRIPTION="Local 8xH200 (vLLM) — fast + free" \\
    ANTHROPIC_DEFAULT_SONNET_MODEL="$AMBIX_MODEL" \\
    ANTHROPIC_DEFAULT_SONNET_MODEL_NAME="$AMBIX_MODEL" \\
    ANTHROPIC_DEFAULT_SONNET_MODEL_DESCRIPTION="Local 8xH200 (vLLM) — fast + free" \\
    ...
    ANTHROPIC_DEFAULT_FABLE_MODEL_DESCRIPTION="Local 8xH200 (vLLM) — fast + free" \\
    ANTHROPIC_SMALL_FAST_MODEL="$AMBIX_MODEL" \\
    ANTHROPIC_SMALL_FAST_MODEL_NAME="$AMBIX_MODEL" \\
    ANTHROPIC_SMALL_FAST_MODEL_DESCRIPTION="Local 8xH200 (vLLM) — fast + free" \\
